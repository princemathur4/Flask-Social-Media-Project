...
def index():
    ...
    return render_template('index5_1.html',title="Home",posts=posts.items,form=form,next_url=next_url,prev_url=prev_url)
...
def explore():
    ...
    return render_template('index5_1.html',title='Explore',posts=posts.items,next_url=next_url,prev_url=prev_url)
